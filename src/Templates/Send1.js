...
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-UK+IE+AE+header+banner+HBW+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-UK+IE+AE+header+banner+HBW+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ elseif CATEGORY_V3 == "Food & Drink" then ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-UK+IE+AE+header+banner+FD+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-+UK+IE+AE+header+banner+FD+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ elseif CATEGORY_V3 == "Leisure Offers / Activities" then ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-+UK+IE+AE+header+banner+TTD+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-UK+IE+AE+header+banner+TTD+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ else ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-+UK+IE+AE+header+banner+Service+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width-->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-+UK+IE+AE+header+banner+Service+updated.png" alt="Offer the Perfect Gift: A Mother’s Day Groupon!" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->
...
Mother’s Day is coming on March 21 — and shoppers start browsing early. Create a giftable Groupon now so customers can send an instant gift, and you can unlock added exposure during Mother’s Day promotions.
...
<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" valign="top" style="padding-left:15px; padding-right:15px; padding-top:9px; padding-bottom:15px; font-size:16px; line-height:24px;"><div style="text-align:left; font-size:16px; line-height:24px; font-family:'Open Sans','Helvetica Neue',Helvetica,Arial,sans-serif; color:#230F33; font-weight:normal;">
  
Here are some top-performing examples from similar businesses on Groupon, to help inspire your own Mother's Day offer:
<br>
...
<li style="padding-top:9px;">
  <strong><a href="%%=RedirectTo(v(@DEAL_URL))=%%" style="color:#008A22; text-decoration:none; font-weight:bold;">%%=v(@MERCHANT)=%%</a> </strong>%%[IF @UNITS_SOLD != '-' THEN]%%- Sold %%=v(@UNITS_SOLD)=%% vouchers.%%[ ENDIF ]%%
</li>
...
<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-quick+win+tips+banner+HBW+updated.png" alt="Quick Win Tips" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-quick+win+tips+banner+HBW+updated.png" alt="Quick Win Tips" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ elseif CATEGORY_V3 == "Food & Drink" then ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-quick+win+tips+banner+FD+updated.png" alt="Quick Win Tips" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-quick+wins+banner+FD+updated.png" alt="Quick Win Tips" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ elseif CATEGORY_V3 == "Leisure Offers / Activities" then ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-quick+win+tips+banner+TTD+updated.png" alt="Quick Win Tips" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width -->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-quick+win+tips+banner+TTD+updated.png" alt="Quick Win Tips" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->


%%[ else ]%%

<!-- DESKTOP IMAGE 600 px width -->
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/600x300px-MD2026-quick+win+tips+banner+Else+updated.png" alt="Quick Win Tips" border="0" class="em_img em_hide" style="display:block; border-radius:10px;" width="600"><!--[if !mso]><!-->

<!-- MOBILE IMAGE 480px width-->
<div class="imghide" style="max-height:0px; font-size:0; display:none; overflow:hidden;">
<img src="https://image.mc.groupon.com/lib/fe3e157075640475711070/m/1/480x200px-MD2026-quick+win+tips+banner+Else+updated.png" alt="Quick Win Tips" border="0" class="imghide em_img em_center" height="0" width="0" style="border-radius:10px;"></div><!--<![endif]-->
...
La fête des Mères approche à grands pas (le 10 mai) et les clients commencent déjà leurs recherches. Créez dès maintenant une offre Groupon dédiée pour permettre à vos clients d'offrir instantanément un cadeau et bénéficiez d'une visibilité maximale sur notre plateforme pendant cette période clé.
...
La fête des Mères approche à grands pas (le 31 mai) et les clients commencent déjà leurs recherches. Créez dès maintenant une offre Groupon dédiée pour permettre à vos clients d'offrir instantanément un cadeau et bénéficiez d'une visibilité maximale sur notre plateforme pendant cette période clé.
...
<!-- / FOOTER -->
  ...
  IE_en: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html style="padding:0;margin:0;opacity:1;" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml">
<head>
<meta content="text/html; charset=utf-8" http-equiv="Content-Type">
<meta content="width=device-width, initial-scale=1.0" name="viewport">
...
Mother’s Day is coming on March 15 — and shoppers start browsing early. Create a giftable Groupon now so customers can send an instant gift, and you can unlock added exposure during Mother’s Day promotions.
...
Review and Optimize your Live Deal
...
%%[ endif ]%%</td></tr></table><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="min-width: 100%; " class="stylingblock-content-wrapper"><tr><td class="stylingblock-content-wrapper camarker-inner"><table align="center" border="0" cellpadding="0" cellspacing="0" class="em_wrapper" style="width:600px;" width="600">
<tr><td align="center" valign="top" style="padding-top:15px; padding-bottom:15px;">
